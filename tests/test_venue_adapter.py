...
class TestVenueAdapterProtocol:
    ...
    def test_conforming_class_isinstance(self) -> None:
        class _FakeAdapter:
            ...
            async def query_order_list(self, *_args: Any, **_kwargs: Any) -> None: ...
            ...
            async def query_fund_transactions(self, *_args: Any, **_kwargs: Any) -> None: ...

            async def query_api_permissions(self, *_args: Any, **_kwargs: Any) -> None: ...
            ...
            def cached_filters(self, *_args: Any, **_kwargs: Any) -> None: ...
