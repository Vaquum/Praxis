...
- Add 1 pre-PR review TD entry (TD-054) to [`docs/TechnicalDebt.md`](docs/TechnicalDebt.md) documenting the synchronous-block tax on `_append_outcome_acked` under loop overload
