...
- Add [`test_validate_trade_abort.py`](tests/test_validate_trade_abort.py) with 7 tests covering valid abort, unknown command_id, terminal no-op, and account_id mismatch
